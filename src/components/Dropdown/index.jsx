...
function Dropdown({ heading, content }) {
  ...
  const toggleState = () => setToggle(!toggle,);
    ...
    return (
        <DropdownWrapper key={{ heading }}>
          <DropdownHeading onClick={toggleState}>
          <DropdownHeader>{heading}</DropdownHeader>
          <Chevron onClick={toggleState} src={chevron} alt="" ></Chevron>

          { toggle && (
          <ClickedChevron src={chevron} alt="" aria-hidden={toggle ? "true" : "false"} >
          </ClickedChevron>)}
          </DropdownHeading> 

          {toggle && (
          <DropdownContent aria-hidden={toggle ? "true" : "false"}>
            {
